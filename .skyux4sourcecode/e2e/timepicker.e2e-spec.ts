...
describe('timepicker', () => {
  ...
  function validateAll(): void {
    ...
    it(
      'should show the timepicker correctly after clicking on the icon for 12 hr',
      async (done) => {
        await element(by.css('#screenshot-timepicker12hr .sky-timepicker button')).click();
    ...
    it(
      'should show the timepicker correctly after clicking on the icon for 24 hr',
      async (done) => {
        await element(by.css('#screenshot-timepicker24hr .sky-timepicker button')).click();
    ...
    it('should match previous timepicker input box screenshot', async (done) => {
      ...
      expect('#screenshot-timepicker-input-box').toMatchBaselineScreenshot(done, {
